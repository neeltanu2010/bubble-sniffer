...
def build_share_text(symbol, financify_score, grade, label, fundamental_score, bubble_score, warren_title):
    ...
    return (
        ...
        f"Fundamental Honey: {fundamental_score}/9 | Bubble Smell: {bubble_score}/7\n"
    ...
    st.markdown(
        ...
        <div class="hook-grid">
            <div class="hook-card">
                ...
                <div class="hook-card-text">{fundamental_score}/9 quality checks passed. This is the business-strength side of the score.</div>
            </div>
            <div class="hook-card">
                <div class="hook-card-title">🐝 Bubble Smell</div>
                <div class="hook-card-text">{bubble_score}/7 hype-risk points detected. Lower is cleaner.</div>
            </div>
            <div class="hook-card">
...
if run:
    ...
    if score >= 8:
        dialogue_box(
            "🍯 Strong Honey",
            "Fundamental score is 8 or above. Premium valuation may be justified only if growth continues and the entry price still leaves margin of safety.",
            "green"
        )
    else:
        dialogue_box(
            "🐝 Fundamental score is below 8",
            "Business quality is not clean enough yet, so the bubble / hype indicators become even more important.",
            "honey"
        )
